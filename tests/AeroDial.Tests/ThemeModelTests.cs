...
public class ThemeModelTests
{
    ...
    [InlineData(0.25f, 0.25f)]   // the built-in themes' icon weight
    ...
    public void Accent_theme_uses_the_same_icon_weight_as_the_built_ins()
        => Assert.Equal(0.25f, AccentThemeBuilder.Build(new SkiaSharp.SKColor(0x33, 0x77, 0xEE)).IconStrokeScale, 3);
}
